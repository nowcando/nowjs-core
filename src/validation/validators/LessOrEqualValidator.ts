...
export function isLessOrEqualTo(anotherTarget: any, anotherPropertyName: string = "", errorMessage?: StringFormatType) {
    ...
    return (target: Object, propertyKey: string | symbol, descriptor: TypedPropertyDescriptor<any>) => {
        ...
        Reflect.defineMetadata(VALIDATOR_METADATA_KEY,
             new LessOrEqualToValidator(anotherTarget, anotherPropertyName, errorMessage), target, propertyKey);
    };
}
