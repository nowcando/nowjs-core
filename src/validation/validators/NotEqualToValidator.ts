...
export function isNotEqualTo(anotherTarget: any, anotherPropertyName = '', errorMessage?: StringFormatType) {
    ...
    return (target: Record<string, any>, propertyKey: string | symbol, descriptor: TypedPropertyDescriptor<any>) => {
        ...
        Reflect.defineMetadata(
            VALIDATOR_METADATA_KEY,
            new NotEqualToValidator(anotherTarget, anotherPropertyName, errorMessage),
            target,
            propertyKey,
        );
    };
