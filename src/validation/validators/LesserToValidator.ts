...
export function isLesserTo(anotherTarget: any, anotherPropertyName = '', errorMessage?: StringFormatType) {
    ...
    return (target: Record<string, any>, propertyKey: string | symbol, descriptor: TypedPropertyDescriptor<any>) => {
        ...
        Reflect.defineMetadata(
            VALIDATOR_METADATA_KEY,
            new LesserToValidator(anotherTarget, anotherPropertyName, errorMessage),
            target,
            propertyKey,
        );
    };
