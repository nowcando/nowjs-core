...
export function compareTo(
    ...
    return (target: Record<string, any>, propertyKey: string | symbol, descriptor: TypedPropertyDescriptor<any>) => {
        ...
        Reflect.defineMetadata(
            ...
            new CompareToValidator(style, anotherTarget, anotherPropertyName, errorMessage),
            target,
            propertyKey,
        );
    };
...
export class CompareToValidatorBase extends ValidatorBase {
    constructor(
        name: string,
        private style: CompareToValidatorStyle,
        private anotherTarget: any,
        private anotherPropertyName: string = '',
