...
export class Stack<T>  implements collections.IStack<T> {
    protected _arr:T[] = [];
    ...
    equalsTo(a:collections.IStack<T>):boolean {
    ...
    compareTo(a:collections.IStack<T>, b:collections.IStack<T>):core.IComparator<collections.IStack<T>> {
        if (<any>a > b) return 1;
