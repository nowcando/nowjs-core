...
export  class ParallelEnumerable<T> implements IParallelQueryable<T> {
    constructor(private enumerable: IAsyncEnumerable<T> | AsyncIterable<T> |IEnumerable<T> | Iterable<T> ,
                private options?: {}) {}
   // tslint:disable:max-line-length
   public async aggregate(action: (seed: T, item: T, index?: number, source?: IAsyncEnumerable<T>) => T, seed?: T): Promise<T> {
  ...
  public  selectMany<TCollection, TResult>(selector: (arg: T) => IAsyncEnumerable<TResult>, collectionSelector?: (arg: TCollection) => TResult): IParallelQueryable<TResult>;
  public  selectMany(selector: any, collectionSelector?: any): IParallelQueryable<any> {
        throw new Error("Method not implemented.");
    }
   public join<TOuter, TInner, TKey, TResult>(inner: IAsyncEnumerable<TInner>, outerSelector: (arg: TOuter) => TKey, innerSelector: (arg: TInner) => TKey, resultSelector: (innerItem: TInner, outerItem: TOuter) => TResult): IParallelQueryable<TResult> {
        throw new Error("Method not implemented.");
    }
  public  where(predicate: (arg: T) => boolean): IParallelQueryable<T> {
   ...
   public orderBy<TSelected>(selector: (arg: T) => TSelected, comparator?: (a: T, b: T) => number): IParallelOrderedQueryable<T> {
        throw new Error("Method not implemented.");
    }
   public orderByDesc<TSelected>(selector: (arg: T) => TSelected, comparator?: (a: T, b: T) => number): IParallelOrderedQueryable<T> {
        throw new Error("Method not implemented.");
    }
  ...
  public async  max(selector?: (arg: T) => number, predicate?: (arg: T) => boolean): Promise<number> {
   ...
   public async percentile(percentile: number, selector?: (arg: T) => number, predicate?: (arg: T) => boolean): Promise<number> {
        throw new Error("Method not implemented.");
    }
   public async percentileInclusive(percentile: number, selector?: (arg: T) => number, predicate?: (arg: T) => boolean): Promise<number> {
        throw new Error("Method not implemented.");
    }
   ...
   public async covariance(other: IParallelQueryable<T>, selector?: (arg: T) => number, predicate?: (arg: T) => boolean): Promise<number> {
        throw new Error("Method not implemented.");
    }
   public async pearson(other: IParallelQueryable<T>, selector?: (arg: T) => number, predicate?: (arg: T) => boolean): Promise<number> {
        throw new Error("Method not implemented.");
    }
   ...
   public  zip<TSecond, TResult>(second: IAsyncEnumerable<TSecond>, selector: (tfirst: T, tsecond: TSecond) => TResult): IParallelQueryable<TResult> {
        throw new Error("Method not implemented.");
    }
