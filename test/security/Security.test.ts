...
import {
    authorize, AuthorizePermissionOptions,
    ISecurityClaim, ISecurityProvider, SecurityException, SecurityManager,
} from "../../src/security";
...
class DummyClass {
    ...
    @authorize()
    public async testfn1(fname: string) { return fname; }
    @authorize({ roles: ["admin"] })
    public async testfn2() { return "task2"; }
}
class DummpySprovider implements ISecurityProvider {
    ...
    public get name() { return "DummySecurityProvider"; }
